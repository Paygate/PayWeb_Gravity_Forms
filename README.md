...
## PayGate Gravity Forms plugin v2.2.10 for Gravity Forms v2.4.15, WordPress v5.3.0
...
Please navigate to the [releases page](https://github.com/PayGate/PayWeb_Gravity_Forms/releases), download the latest release (v2.2.10) and unzip. You will them be able to follow the integration guide PDF which is included in the zip.
